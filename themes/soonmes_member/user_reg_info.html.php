							...
							<tr>
								...
								<td><div class="input_style01">
										<span class="r"><input id="username" name="username"
											...
											onFocus="this.className='biankuang1';"
											onBlur="this.className='biankuang2';checkUsername(this.value);"></span>
									</div>
							...
							<tr>
								...
								<td><div class="input_style01">
										<span class="r"><input id="password" name="password"
											...
											onFocus="this.className='biankuang1';"
											onBlur="this.className='biankuang2';checkPassword(this.value);"></span>
									</div>
							...
							<tr>
								...
								<td><div class="input_style01">
										<span class="r"><input id="conform_password"
											...
											maxlength="20" value=""
											onFocus="this.className='biankuang1';"
											onBlur="this.className='biankuang2';checkConformPassword(this.value);"></span>
									</div>
