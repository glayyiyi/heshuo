...
<table width="100%" height="166" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="20"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="login-buttom-bg">
            <tr>
                <td align="center"><span class="login-buttom-txt">Powered by　<strong><a href="http://www.erongdu.com" style="color:#fff;">RDTECH</a>　V6.5</strong> <font color="#FF9900"></font> &copy; 2010-2012, RONGDU &nbsp;Inc.</span></td>
            </tr>
        </table></td>
    </tr>
</table>
