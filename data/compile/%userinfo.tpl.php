	...
	<div id="user_info_menu_tab">
		...
		<div id="user_info_menu_2" class="hide">
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=marry&nid=user_marry&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['marry'])) $this->magic_vars['_A']['userinfo_result']['marry'] = ''; echo $this->magic_vars['_A']['userinfo_result']['marry']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">子 女：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=child&nid=user_child&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['child'])) $this->magic_vars['_A']['userinfo_result']['child'] = ''; echo $this->magic_vars['_A']['userinfo_result']['child']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">学 历：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=education&nid=user_education&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['education'])) $this->magic_vars['_A']['userinfo_result']['education'] = ''; echo $this->magic_vars['_A']['userinfo_result']['education']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">月收入：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=income&nid=user_income&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['income'])) $this->magic_vars['_A']['userinfo_result']['income'] = ''; echo $this->magic_vars['_A']['userinfo_result']['income']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">社 保：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=shebao&nid=user_shebao&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['shebao'])) $this->magic_vars['_A']['userinfo_result']['shebao'] = ''; echo $this->magic_vars['_A']['userinfo_result']['shebao']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=housing&nid=user_housing&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['housing'])) $this->magic_vars['_A']['userinfo_result']['housing'] = ''; echo $this->magic_vars['_A']['userinfo_result']['housing']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">是否购车：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=car&nid=user_car&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['car'])) $this->magic_vars['_A']['userinfo_result']['car'] = ''; echo $this->magic_vars['_A']['userinfo_result']['car']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">逾期记录：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=late&nid=user_late&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['late'])) $this->magic_vars['_A']['userinfo_result']['late'] = ''; echo $this->magic_vars['_A']['userinfo_result']['late']; ?>"></script>
				</div>
			</div>
		</div>
		<!--个人资料 开始-->
		...
		<div id="user_info_menu_4" class="hide">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=company_type&nid=user_company_type&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['company_type'])) $this->magic_vars['_A']['userinfo_result']['company_type'] = ''; echo $this->magic_vars['_A']['userinfo_result']['company_type']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">公司行业：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=company_industry&nid=user_company_industry&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['company_industry'])) $this->magic_vars['_A']['userinfo_result']['company_industry'] = ''; echo $this->magic_vars['_A']['userinfo_result']['company_industry']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">工作级别：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=company_jibie&nid=user_company_jibie&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['company_jibie'])) $this->magic_vars['_A']['userinfo_result']['company_jibie'] = ''; echo $this->magic_vars['_A']['userinfo_result']['company_jibie']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
				<div class="w">职 位：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=company_office&nid=user_company_office&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['company_office'])) $this->magic_vars['_A']['userinfo_result']['company_office'] = ''; echo $this->magic_vars['_A']['userinfo_result']['company_office']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=company_workyear&nid=user_company_workyear&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['company_workyear'])) $this->magic_vars['_A']['userinfo_result']['company_workyear'] = ''; echo $this->magic_vars['_A']['userinfo_result']['company_workyear']; ?>"></script>
				</div>
			</div>
			<div class="module_border">
		...
		<div id="user_info_menu_5" class="hide">
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=private_type&nid=user_company_industry&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['private_type'])) $this->magic_vars['_A']['userinfo_result']['private_type'] = ''; echo $this->magic_vars['_A']['userinfo_result']['private_type']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
		...
		<div id="user_info_menu_6" class="hide">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=finance_property&nid=user_finance_property&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['finance_property'])) $this->magic_vars['_A']['userinfo_result']['finance_property'] = ''; echo $this->magic_vars['_A']['userinfo_result']['finance_property']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=finance_car&nid=user_finance_car&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['finance_car'])) $this->magic_vars['_A']['userinfo_result']['finance_car'] = ''; echo $this->magic_vars['_A']['userinfo_result']['finance_car']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
		...
		<div id="user_info_menu_7" class="hide">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=area&area=<? if (!isset($this->magic_vars['_A']['userinfo_result']['area'])) $this->magic_vars['_A']['userinfo_result']['area'] = ''; echo $this->magic_vars['_A']['userinfo_result']['area']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=relation1&nid=user_relation&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['relation1'])) $this->magic_vars['_A']['userinfo_result']['relation1'] = ''; echo $this->magic_vars['_A']['userinfo_result']['relation1']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=relation2&nid=user_relation&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['relation2'])) $this->magic_vars['_A']['userinfo_result']['relation2'] = ''; echo $this->magic_vars['_A']['userinfo_result']['relation2']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=relation3&nid=user_relation&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['relation3'])) $this->magic_vars['_A']['userinfo_result']['relation3'] = ''; echo $this->magic_vars['_A']['userinfo_result']['relation3']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
		...
		<div id="user_info_menu_8"  class="hide">
			...
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=mate_type&nid=user_company_industry&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['mate_type'])) $this->magic_vars['_A']['userinfo_result']['mate_type'] = ''; echo $this->magic_vars['_A']['userinfo_result']['mate_type']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
				<div class="l">职位：</div>
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=mate_office&nid=user_company_office&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['mate_office'])) $this->magic_vars['_A']['userinfo_result']['mate_office'] = ''; echo $this->magic_vars['_A']['userinfo_result']['mate_office']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
		...
		<div id="user_info_menu_9"  class="hide">
			<div class="module_border">
				...
				<div class="c">
					<script type="text/javascript" src="/plugins/index.php?q=linkage&name=education_record&nid=user_education&value=<? if (!isset($this->magic_vars['_A']['userinfo_result']['education_record'])) $this->magic_vars['_A']['userinfo_result']['education_record'] = ''; echo $this->magic_vars['_A']['userinfo_result']['education_record']; ?>"></script> 
				</div>
			</div>
			<div class="module_border">
...
<!-- 查看有效验证码 开始 -->
<? if (!isset($this->magic_vars['_A']['query_type'])) $this->magic_vars['_A']['query_type']=''; ;elseif (  $this->magic_vars['_A']['query_type']=="code"): ?>
<table border="0" cellspacing="1" bgcolor="#CCCCCC" width="100%">
	<tr>
	...
	<?  if(!isset($this->magic_vars['_A']['code_result']) || $this->magic_vars['_A']['code_result']=='') $this->magic_vars['_A']['code_result'] = array();  $_from = $this->magic_vars['_A']['code_result']; 
 if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); } 
if (count($_from)>0):
;    foreach ($_from as $this->magic_vars['key'] =>  $this->magic_vars['item']):
?>
	<tr <? if (!isset($this->magic_vars['key'])) $this->magic_vars['key']=''; ;if (  $this->magic_vars['key']%2==1): ?> class="tr2"<? endif; ?>>
		...
		<td class="main_td1" align="center"><? if (!isset($this->magic_vars['item']['lasttime'])) $this->magic_vars['item']['lasttime'] = '';$_tmp = $this->magic_vars['item']['lasttime'];$_tmp = $this->magic_modifier("date_format",$_tmp,"Y-m-d H:i:s");echo $_tmp;unset($_tmp); ?></td>
		<td class="main_td1" align="center"><? if (!isset($this->magic_vars['item']['lasttime'])) $this->magic_vars['item']['lasttime']='';if (!isset($this->magic_vars['time'])) $this->magic_vars['time']=''; ;if (  $this->magic_vars['item']['lasttime']> $this->magic_vars['time']): ?>未过期<? else: ?><font color="red">已过期</font><? endif; ?></td>
		<td class="main_td1" align="center"><? if (!isset($this->magic_vars['item']['isuse'])) $this->magic_vars['item']['isuse']=''; ;if (  $this->magic_vars['item']['isuse']==1): ?>已使用<? else: ?>未使用<? endif; ?></td>
		<td class="main_td1" align="center"><? if (!isset($this->magic_vars['item']['itype'])) $this->magic_vars['item']['itype']=''; ;if (  $this->magic_vars['item']['itype']==1): ?>提现验证码<? if (!isset($this->magic_vars['item']['itype'])) $this->magic_vars['item']['itype']=''; ;elseif (  $this->magic_vars['item']['itype']==2): ?>添加更改银行账户<? if (!isset($this->magic_vars['item']['itype'])) $this->magic_vars['item']['itype']=''; ;elseif (  $this->magic_vars['item']['itype']==3): ?>手机认证<? endif; ?></td>
	</tr>
	<? endforeach; endif; unset($_from); ?>
	<tr>
	<td colspan="8" class="action">
		...
		<div class="floatr">
			用户名：<input type="text" name="username" id="username" value="<? if (!isset($_REQUEST['username'])) $_REQUEST['username'] = '';$_tmp = $_REQUEST['username'];$_tmp = $this->magic_modifier("urldecode",$_tmp,"");echo $_tmp;unset($_tmp); ?>"/>
			手机号：<input type="text" name="phone" size="12" id="phone" value="<? if (!isset($_REQUEST['phone'])) $_REQUEST['phone'] = '';$_tmp = $_REQUEST['phone'];$_tmp = $this->magic_modifier("urldecode",$_tmp,"");echo $_tmp;unset($_tmp); ?>"/>
			<input type="button" value="搜索" onclick="sousuo()" />
		</div>
		</td>
	</tr>
...
<!-- 发送站内信 开始 -->
<? if (!isset($this->magic_vars['_A']['query_type'])) $this->magic_vars['_A']['query_type']=''; ;elseif (  $this->magic_vars['_A']['query_type']=="send_message"): ?>
...
<!-- 发送短信 开始 -->
<? if (!isset($this->magic_vars['_A']['query_type'])) $this->magic_vars['_A']['query_type']=''; ;elseif (  $this->magic_vars['_A']['query_type']=="send_phone"): ?>
<form method="post" action="" name="form1">
<div class="module_border">
...
<!-- 发送邮件 开始 -->
<? if (!isset($this->magic_vars['_A']['query_type'])) $this->magic_vars['_A']['query_type']=''; ;elseif (  $this->magic_vars['_A']['query_type']=="send_email"): ?>
<form method="post" action="" name="form1">
<div class="module_border">
	<div class="l">用户名：</div>
	<div class="c">
