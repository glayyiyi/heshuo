	...
	<div class="user_right">
		<div class="user_right_menu">
			<ul id="tab" class="list-tab-narrow clearfix">
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="building"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/building">房产资料</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="company"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/company">单位资料</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="firm"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/firm">私营业主</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="finance"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/finance">财务状况</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="contact"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/contact">联系方式</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="mate"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/mate">配偶资料</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="edu"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/edu">教育背景</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="job"): ?> class="cur"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/job">其他</a></li>
			</ul>
		</div>
		...
		<!--个人资料 开始-->
					...
					<? if (!isset($this->magic_vars['_G']['user_result']['username'])) $this->magic_vars['_G']['user_result']['username'] = ''; echo $this->magic_vars['_G']['user_result']['username']; ?>
                        ...
                        <div class="user_right_border">
                                ...
                                <div class="c">
                                    ...
                                    <? if (!isset($this->magic_vars['_G']['user_result']['realname'])) $this->magic_vars['_G']['user_result']['realname'] = ''; echo $this->magic_vars['_G']['user_result']['realname']; ?>(您已通过实名认证，不允许修改真实姓名)
                                    <? else: ?>
                                        <input  name="realname" value="<? if (!isset($this->magic_vars['_G']['user_result']['realname'])) $this->magic_vars['_G']['user_result']['realname'] = ''; echo $this->magic_vars['_G']['user_result']['realname']; ?>" />
                                    <? endif; ?>
                                </div>
                        </div>
			...
			<div class="user_right_border">
				...
				<div class="c">
                                          ...
                                          <input type="radio" name="sex" value="1" <? if (!isset($this->magic_vars['_G']['user_result']['sex'])) $this->magic_vars['_G']['user_result']['sex']='';if (!isset($this->magic_vars['_G']['user_result']['sex'])) $this->magic_vars['_G']['user_result']['sex']=''; ;if (  $this->magic_vars['_G']['user_result']['sex']==1 ||  $this->magic_vars['_G']['user_result']['sex']==""): ?>  checked="checked"  <? endif; ?> />男
                                          <input type="radio" name="sex" value="2" <? if (!isset($this->magic_vars['_G']['user_result']['sex'])) $this->magic_vars['_G']['user_result']['sex']=''; ;if (  $this->magic_vars['_G']['user_result']['sex']==2): ?>  checked="checked"  <? endif; ?> />女
				</div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
                                    ...
                                    <? if (!isset($this->magic_vars['_G']['user_result']['realname'])) $this->magic_vars['_G']['user_result']['realname'] = ''; echo $this->magic_vars['_G']['user_result']['realname']; ?>(您已通过手机认证，不允许修改手机号码)
                                    <? else: ?>
                                       <input type="text" name="phone" value="<? if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status']='';if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status']=''; ;if (  $this->magic_vars['_G']['user_result']['phone_status']==0 ||   $this->magic_vars['_G']['user_result']['phone_status']==1): ?><? if (!isset($this->magic_vars['_G']['user_result']['phone'])) $this->magic_vars['_G']['user_result']['phone'] = ''; echo $this->magic_vars['_G']['user_result']['phone']; ?><? else: ?><? if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status'] = ''; echo $this->magic_vars['_G']['user_result']['phone_status']; ?><? endif; ?>" />  
				    <? endif; ?>
                                </div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
                                    <? if (!isset($this->magic_vars['_G']['user_result']['real_status'])) $this->magic_vars['_G']['user_result']['real_status']=''; ;if (  $this->magic_vars['_G']['user_result']['real_status']==1): ?> 
                                    <? if (!isset($this->magic_vars['_G']['user_result']['area'])) $this->magic_vars['_G']['user_result']['area'] = '';$_tmp = $this->magic_vars['_G']['user_result']['area'];$_tmp = $this->magic_modifier("area",$_tmp,"");echo $_tmp;unset($_tmp); ?>(您已通过实名认证，不允许修改籍贯)
                                    <? else: ?>
		...
		<div class="user_right_border">
			...
			<div class="user_right_border">
				...
				<div class="c">
					<input type="text" size="25" name="house_status" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['house_status'])) $this->magic_vars['_U']['userinfo_result']['house_status'] = ''; echo $this->magic_vars['_U']['userinfo_result']['house_status']; ?>" /> 元
				</div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
					贷款年限：<input type="text" size="10" name="house_loanyear" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['house_loanyear'])) $this->magic_vars['_U']['userinfo_result']['house_loanyear'] = ''; echo $this->magic_vars['_U']['userinfo_result']['house_loanyear']; ?>" />每月供款：<input type="text" size="10" name="house_loanprice" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['house_loanprice'])) $this->magic_vars['_U']['userinfo_result']['house_loanprice'] = ''; echo $this->magic_vars['_U']['userinfo_result']['house_loanprice']; ?>" /> 元
				</div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
					<input type="text" size="25" name="house_balance" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['house_balance'])) $this->magic_vars['_U']['userinfo_result']['house_balance'] = ''; echo $this->magic_vars['_U']['userinfo_result']['house_balance']; ?>" /> 元
				</div>
			</div>
		...
		<div class="user_help alert">请填写您个人业主资料</div>
		 <form action="" method="post">
			...
			<div class="user_right_border">
				<div class="l">租金：</div>
				<div class="c">
					<input type="text" size="25" name="private_rent" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['private_rent'])) $this->magic_vars['_U']['userinfo_result']['private_rent'] = ''; echo $this->magic_vars['_U']['userinfo_result']['private_rent']; ?>" /> 元
				</div>
			</div>
			...
			<div class="user_right_border">
				<div class="l">租期：</div>
				<div class="c">
					<input type="text" size="25" name="private_term" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['private_term'])) $this->magic_vars['_U']['userinfo_result']['private_term'] = ''; echo $this->magic_vars['_U']['userinfo_result']['private_term']; ?>" /> 月
				</div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
					<input type="text" size="25" name="private_income" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['private_income'])) $this->magic_vars['_U']['userinfo_result']['private_income'] = ''; echo $this->magic_vars['_U']['userinfo_result']['private_income']; ?>" /> 元（年度）
				</div>
			</div>
			...
			<div class="user_right_border">
				...
				<div class="c">
					<input type="text" size="25" name="private_employee" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['private_employee'])) $this->magic_vars['_U']['userinfo_result']['private_employee'] = ''; echo $this->magic_vars['_U']['userinfo_result']['private_employee']; ?>" /> 人
				</div>
			</div>
		...
		* 温馨提示：我们将对所有的信息进行保密
		...
		<div class="user_right_border">
			...
			<div class="c">
				<input type="text" size="15" name="finance_repayment" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['finance_repayment'])) $this->magic_vars['_U']['userinfo_result']['finance_repayment'] = ''; echo $this->magic_vars['_U']['userinfo_result']['finance_repayment']; ?>" /> 元
			</div>
		</div>
		...
		<div class="user_right_border">
			...
			<div class="c">
				<input type="text" size="15" name="finance_amount" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['finance_amount'])) $this->magic_vars['_U']['userinfo_result']['finance_amount'] = ''; echo $this->magic_vars['_U']['userinfo_result']['finance_amount']; ?>" /> 元
			</div>
		</div>
		...
		<div class="user_right_border">
			...
			<div class="c">
				<input type="text" size="15" name="finance_caramount" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['finance_caramount'])) $this->magic_vars['_U']['userinfo_result']['finance_caramount'] = ''; echo $this->magic_vars['_U']['userinfo_result']['finance_caramount']; ?>" /> 元
			</div>
		</div>
		...
		<div class="user_right_border">
			...
			<div class="c">
				<input type="text" size="15" name="finance_creditcard" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['finance_creditcard'])) $this->magic_vars['_U']['userinfo_result']['finance_creditcard'] = ''; echo $this->magic_vars['_U']['userinfo_result']['finance_creditcard']; ?>" /> 元
			</div>
		</div>
		...
		<div class="user_right_border">
			<div class="l">时间：</div>
			<div class="c">
				<input type="text" size="25" name="education_time1" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['education_time1'])) $this->magic_vars['_U']['userinfo_result']['education_time1'] = ''; echo $this->magic_vars['_U']['userinfo_result']['education_time1']; ?>" onclick="change_picktime()" /> 
				到 
				<input type="text" size="25" name="education_time2" value="<? if (!isset($this->magic_vars['_U']['userinfo_result']['education_time2'])) $this->magic_vars['_U']['userinfo_result']['education_time2'] = ''; echo $this->magic_vars['_U']['userinfo_result']['education_time2']; ?>" onclick="change_picktime()" /> 
			</div>
		</div>
		...
		<div class="user_right_border">
			...
			<div class="c">
				<textarea rows="7" cols="50" name="ability"><? if (!isset($this->magic_vars['_U']['userinfo_result']['ability'])) $this->magic_vars['_U']['userinfo_result']['ability'] = ''; echo $this->magic_vars['_U']['userinfo_result']['ability']; ?></textarea><br />（如电脑能力、组织协调能力或其他） 
			</div>
		</div>
		...
		<div class="user_right_border">
			...
			<div class="c">
				<textarea rows="7" cols="50" name="interest"><? if (!isset($this->magic_vars['_U']['userinfo_result']['interest'])) $this->magic_vars['_U']['userinfo_result']['interest'] = ''; echo $this->magic_vars['_U']['userinfo_result']['interest']; ?></textarea><br />（突出自己的个性，工作态度或他人对自己的评价等）
			</div>
		</div>
